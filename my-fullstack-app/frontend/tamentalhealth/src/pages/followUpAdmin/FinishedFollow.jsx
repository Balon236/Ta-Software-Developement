...
import FinishedFollowUpStudent from "../../components/FollowUpComponent/finishedFollowUpStudent";
const FinishedFollowUp = () => {
  return (
...
export default FinishedFollowUp;
