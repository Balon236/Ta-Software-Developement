...
import ReferredView from "../../components/CaseManagerDashboard/referred/referredView";
const CaseManagerRefer = () => {
  return (
      ...
      <div className="header-sec">
        <header className="flex flex-wrap justify-between items-center mb-[30px]">
          <div className="header-title">
            ...
            <p className="mt-[5px] text-[#1E74FF]">View and Refer Client</p>
          </div>
...
export default CaseManagerRefer;
