...
import ClassManager from "../../components/CaseManagerDashboard/classpage/createClass";

const CaseManagerClass = () => {
  return (
      ...
      <div className="mb-6">
        <header className="flex flex-wrap justify-between items-center mb-6">
          <div className="w-full sm:w-auto mb-4 sm:mb-0">
            ...
            <p className="mt-1 text-primary">View and Add New Class</p>
          </div>
...
export default CaseManagerClass;
