...
import SpecialtyManager from "../../components/CaseManagerDashboard/specialty/createSpecialty";
const CaseManagerSpecialty = () => {
  return (
...
export default CaseManagerSpecialty;
