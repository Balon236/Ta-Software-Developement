...
const CreateRegion = () => {
  return (
    ...
    <div className='w-[99%] py-3 px-8 rounded-bl-lg bg-white mt-10 flex items-center justify-between rounded-md border border-blue-300'>
      <Link to="/dashboard/region" className='max-w-[27rem] text-center w-full'>View All Regions</Link> 
      <Link to="/dashboard/region/createregion" className='max-w-[27rem] text-center w-full py-3 bg-blue-600 text-white rounded-lg'>Add a Region</Link> 
    </div>
