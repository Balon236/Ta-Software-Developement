      ...
      <div className="w-[99%] py-5 px-8 rounded-bl-lg bg-white mt-5 rounded-md border border-blue-300">
        ...
        <div className="flex items-center justify-between py-3">
          <div className="flex items-center gap-2">
            ...
            <input
              type="number"
              className="w-[35px] border border-gray-500 text-center rounded-md"
            />
        ...
        <table className="mt-4 w-full table-auto border-collapse">
          <thead className="bg-blue-100">
            <tr>
              <th className="py-3 px-4 text-center text-blue-500 font-normal">
                FULL NAME & EMAIL
              </th>
              <th className="py-3 px-4 text-center text-blue-500 font-normal">
        ...
        <div className="flex items-center justify-end gap-1.5 mt-3">
          ...
          <div className="flex items-center ">
            <span className="py-[2px] px-2 bg-blue-600 text-white rounded-md cursor-pointer">
              1
            </span>
            <span className="py-[2px] px-2  text-gray-400 cursor-pointer">
              2
            </span>
            <span className="py-[2px] px-2 text-gray-400 cursor-pointer">
              3
