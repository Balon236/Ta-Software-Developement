...
const ViewCaseManger = () => {
  return (
    <div className='relative'>
    <div className='flex items-center justify-between'>
        <div className='flex flex-col gap-1'>
         <h2 className='text-blue-600 text-2xl font-medium'>Case Managers</h2>
    ...
    <div className='w-[99%] py-3 px-8 rounded-bl-lg bg-white mt-10 flex items-center justify-between rounded-md border border-blue-300'>
      <Link to="/dashboard/casemanager" className='max-w-[27rem] text-center w-full py-3 bg-blue-600 text-white rounded-lg'>View All Case Managers</Link> 
      <Link to="/dashboard/casemanager/createcasemanager" className='max-w-[27rem] text-center w-full'>Create a Case Manager</Link> 
    </div>
    <div className='w-[99%] py-5 px-8 rounded-bl-lg bg-white mt-5 rounded-md border border-blue-300'>
       <h2>All Case Managers</h2>
       <div className='flex items-center justify-between py-3'>
        ...
        <div className='max-w-[25rem] w-full px-2 rounded-md border border-gray-500 flex items-center'>
            <i className='bx bx-search text-gray-500'></i>
            <input type="text" className='flex-1 py-2 px-3 bg-transparent border-0 outline-0' placeholder='search category' />
        </div>
        <div className='flex items-center gap-5'>
  ...
  <thead className="bg-blue-100">
    <tr>
      <th className="py-3 px-4 text-center text-blue-500 font-normal">FULL NAME & EMAIL</th>
      <th className="py-3 px-4 text-center text-blue-500 font-normal">PHONE/WHATSAPP NUMBER</th>
      <th className="py-3 px-4 text-center text-blue-500 font-normal">DATE OF BIRTH</th>
      <th className="py-3 px-4 text-center text-blue-500 font-normal">GENDER</th>
      <th className="py-3 px-4 text-center text-blue-500 font-normal">LANGUAGE</th>
      ...
      <td className="py-3 px-4">
        <div className="flex items-center gap-3">
          ...
          <div className='flex items-center gap-1.5'>
             ...
             <div className='flex flex-col gap-1'>
                <h2>MRS racheal Ndip Agbor</h2>
                <p className='text-blue-600'>rachealndip908@gmail.com</p>
             </div>
          </div>
        </div>
      </td>
      <td className="py-3 px-4 text-center">P.O Box Molikko Buea</td>
      <td className="py-3 px-4 text-center">divisional</td>
      <td className="py-3 px-4 text-center">21/05/2023</td>
      <td className="py-3 px-4 text-center">french,english</td>
      <td className="py-3 px-4">
