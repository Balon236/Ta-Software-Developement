...
const ViewCategory = () => {
  return (
    ...
    <div className='w-[99%] py-3 px-8 rounded-bl-lg bg-white mt-10 flex items-center justify-between rounded-md border border-blue-300'>
      <Link to="/dashboard/category" className='max-w-[27rem] text-center w-full py-3 bg-blue-600 text-white rounded-lg'>View All Categories</Link> 
      <Link to="/dashboard/category/createcategory" className='max-w-[27rem] text-center w-full'>Create a Category</Link> 
    </div>
  ...
  <thead className="bg-blue-100">
    <tr>
      ...
      <th className="py-3 px-4 text-center text-blue-500 font-normal">REGION</th>
      <th className="py-3 px-4 text-center text-blue-500 font-normal">CATEGORY</th>
