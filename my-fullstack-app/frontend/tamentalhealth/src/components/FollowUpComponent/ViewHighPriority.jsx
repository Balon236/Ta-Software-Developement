...
function ViewHighPriority() {
  ...
  return (
    <div className="follow-up-container">
      <h2 className="follow-up-title">Student With High Priority</h2>
        ...
        <tbody>
          {paginatedData.map((item) => (
            <tr key={item.id}>
              ...
              <td className="fullName-column">{item.studentName}</td>

              <td className="school-name-column">{item.class}</td>

              <td className="referLink-column">
                <a href={item.screeningResult} className="sevierity-link">
                  Link
                </a>
              </td>

              <td className="school-name-column">{item.consultant}</td>

              <td className="referLink-column">
                <a href={item.consResult} className="follow-up-link">
                  View
                </a>
              </td>
