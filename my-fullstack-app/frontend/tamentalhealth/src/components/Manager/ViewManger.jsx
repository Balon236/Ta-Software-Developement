  ...
  return (
    ...
    <div className='flex items-center justify-between'>
        <div className='flex flex-col gap-1'>
         <h2 className='text-blue-600 text-2xl font-medium'>Managers</h2>
         <p className='text-blue-500'>View and add more managers</p>
        </div>
    ...
    <div className='w-[99%] py-3 px-8 rounded-bl-lg bg-white mt-10 flex items-center justify-between rounded-md border border-blue-300'>
      <Link to="/dashboard/manager" className='max-w-[27rem] text-center w-full py-3 bg-blue-600 text-white rounded-lg'>View All Managers</Link> 
      <Link to="/dashboard/manager/createmanager" className='max-w-[27rem] text-center w-full'>Create a Manager</Link> 
    </div>
