...
function ViewOnboardClients() {
  ...
  const [selectedClient, setSelectedClient] = useState(null); // Track selected client for modal
  ...
  return (
    <div className="follow-up-container">
      <h2 className="follow-up-title">On-Boarding Clients</h2>
        ...
        <tbody>
          {paginatedData.map((item) => (
            <tr key={item.id}>
              ...
              <td
                className="fullName-column"
                onClick={() => handleClientClick(item)} // Add click handler
              ...
              <td className="school-name-column">{item.phoneNum}</td>
              <td className="school-name-column">{item.class}</td>
              <td className="referLink-column">{item.age}</td>
              <td className="referLink-column">{item.gender}</td>
