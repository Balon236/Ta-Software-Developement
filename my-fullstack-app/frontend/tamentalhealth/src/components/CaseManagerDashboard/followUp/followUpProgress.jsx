...
function FollowUpProgress() {
  ...
  const handleExport = () => {
    const csvContent =
      ...
      ["studentName,School Name,Result,Refer,details"]
        .concat(
          filteredData.map(
            (item) =>
    ...
    link.setAttribute("download", "mild_sevierity_data.csv");
  ...
  return (
    <div className="follow-up-container">
      <h2 className="follow-up-title">Follow Up Progress</h2>
          ...
          {paginatedData.map((item) => (
            <tr key={item.id}>
              ...
              <td className="referLink-column">
                <a href={item.details} className="follow-up-link">
                  View
                </a>
              </td>
