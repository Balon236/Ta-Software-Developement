...
const ViewCriticalSevierity = () => {
  ...
  const handleExport = () => {
    ...
    link.setAttribute("download", "critical_sevierity_data.csv");
  ...
  return (
    <div className="sevierity-container">
      <h1 className="sevierity-title">Client Facing Critical Sevierity</h1>
...
export default ViewCriticalSevierity;
