...
const ViewHighSevierity = () => {
  ...
  const handleExport = () => {
    ...
    link.setAttribute("download", "high_sevierity_data.csv");
  ...
  return (
    <div className="sevierity-container">
      <h1 className="sevierity-title">Client Facing High Sevierity</h1>
...
export default ViewHighSevierity;
