export default function AddNew(){
    return (
        ...
        <div className="w-full border border-brand-500 p-10 bg-white ">
            <p className="text-2xl text-center text-brand-500">Enter New Details of the body mass index</p>
            <div className="border border-gray-300 p-10 mt-5 px-auto w-full ">
                <div className="mx-auto mb-4">
                    <label  className="block text-xl font-medium text-gray-700 mb-2">Height</label>
                    <input 
                        type="number" 
                        id="height" 
                        name="height"
