...
interface HeaderProps {
  title: string; // Optional function that takes no arguments and returns void
  subTitle: string;
}
...
const AppHeader: React.FC<HeaderProps> = ({ title, subTitle}) => {
  ...
  return (
    <header className="flex w-full  border-gray-200 z-99999   lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <div>
            ...
            <p className="mt-1 text-[#1e74ff] text-base">{subTitle}</p>
          </div>
