...
const ViewCriticalSeverity = () => {
  ...
  */]);
  ...
  const [selectedIds, setSelectedIds] = useState([]);
   ...
   useEffect(() => {
      const fetchMildClients = async () => {
        try {
          const response = await axios.get("http://localhost:8000/api/clients/filter/critical");
  ...
  const handleExport = () => {
    ...
    link.setAttribute("download", "critical_severity_data.csv");
...
export default ViewCriticalSeverity;
