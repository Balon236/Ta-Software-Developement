 ...
 */ ]);
  ...
  const [selectedIds, setSelectedIds] = useState([]);
   ...
   useEffect(() => {
      const fetchMildClients = async () => {
        try {
          const response = await axios.get("http://localhost:8000/api/clients/filter/high");
  ...
  const handleExport = () => {
    ...
    link.setAttribute("download", "high_severity_data.csv");
...
export default ViewHighSeverity;
