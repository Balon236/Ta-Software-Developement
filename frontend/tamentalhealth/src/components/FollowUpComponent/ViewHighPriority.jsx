...
function ViewHighPriority() {
  ...
  */]);
    ...
    const fetchFollowUps = async () => {
      try {
        const response = await axios.get(
          "http://localhost:8000/api/followup/filter/priority/high",
          {
            params: {
              manager_id: 1,
            },
  ...
  id: index + 1, // or use a real unique ID if available
  studentName: item.client_name || "N/A",
  code: item.code || "N/A",
  class: item.class || "N/A",
  screeningResult: "here is the link", // update as needed
  consultant: item.consultant || "N/A",
  consResult: "here is the link", // update as needed
}));
...
export default ViewHighPriority;
