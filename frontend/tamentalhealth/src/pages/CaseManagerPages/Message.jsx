...
import CreaeteMessage from "../../components/CaseManagerDashboard/message/createMesage";
const CaseManagerMessage = () => {
  return (
      ...
      <div className="header-sec">
        <header className="flex flex-wrap justify-between items-center mb-[30px]">
          <div className="header-title">
            ...
            <p className="mt-[5px] text-[#1E74FF]">View and Create Message</p>
          </div>
...
export default CaseManagerMessage;
